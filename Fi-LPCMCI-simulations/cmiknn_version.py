...
for j in n:
    for i in range(num_datasets):
        ...
        result = cmiknn_lpcmci(data, ground_truth)
...
# Print the DataFrame
print(df_1)
df_1.to_csv('/home/gnicolaou/tigramite/tigramite/simulations_results/cmiknn_5_extended.csv')
...
# Print the DataFrame
print(df_2)
df_2.to_csv('/home/gnicolaou/tigramite/tigramite/simulations_results/cmiknn_10_extended.csv')
...
# Print the DataFrame
print(df_3)
df_3.to_csv('/home/gnicolaou/tigramite/tigramite/simulations_results/cmiknn_15_extended.csv')
